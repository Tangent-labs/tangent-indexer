...
describe("PredepositCampaignServiceDecrease - Decrease amounts part", () => {
  ...
  getOnchainSnapshotSpy = vi.spyOn(predepositService as any, "getOnchainSnapshot")
  ...
  it("Test when the getLastPredepositCampaignBlock is undefined", async () => {
    ...
    getAllAccountedBalancesSpy = vi.spyOn(predepositCampaignRepository, "getAllAccountedBalances").mockResolvedValue([
