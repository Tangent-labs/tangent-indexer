...
describe("PredepositCampaignServiceDecrease - Decrease amounts part", () => {
  ...
  const PUBLIC_USERS = [{ user_address: "USER0".toLowerCase() }, { user_address: "USER1".toLowerCase() }, { user_address: "USER2".toLowerCase() }]
  ...
  vi.spyOn(predepositCampaignRepository, "getAllAccountedBalances").mockResolvedValue([
    ...
    { id: 2n, user_address: "USER0".toLowerCase(), usg_lp: { lp_name: "USG-frxUSD" }, balance_lp: parseEther("1000000").toString(), usg_lp_id: 2n },
    { id: 3n, user_address: "USER2".toLowerCase(), usg_lp: { lp_name: "USG-USDC" }, balance_lp: parseEther("1500000").toString(), usg_lp_id: 1n },
    { id: 4n, user_address: "USER1".toLowerCase(), usg_lp: { lp_name: "USG-frxUSD" }, balance_lp: parseEther("500000").toString(), usg_lp_id: 2n },
  ])
